...
double call_localSearch(Instance& instance, std::string method = "trade_ungotted");
...
double geneticAlgorithm(Instance& instance, int num_generations = 10, int pop_size = 20, double alpha = 0.8, double beta = 0.1, bool verbose = false);

void random_greedy(Instance& instance);
